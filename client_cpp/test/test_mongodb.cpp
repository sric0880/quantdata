...
void test_get_trade_cal()
{
  ...
  QD_ASSERT(std::get<0>(results[0]) == Datetime<std::milli>(2024, 8, 20).to_duration(), "");
  QD_ASSERT(std::get<0>(results[results.size() - 1]) == Datetime<std::milli>(2024, 9, 19).to_duration(), "");
  ...
  QD_ASSERT(std::get<0>(results2[0]) == Datetime<std::milli>(2024, 8, 19).to_duration(), "");
  ...
  QD_ASSERT(std::get<0>(results3[results3.size() - 1]) == Datetime<std::milli>(2024, 9, 13).to_duration(), "");
